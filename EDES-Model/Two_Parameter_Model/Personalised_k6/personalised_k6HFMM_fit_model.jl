...
CSV.write(" HFMM_personalised_k6_estimates.csv", ogtts; transform=(col, val) -> something(val, missing))
CSV.write("HFMM_personalised_k6_OGTTsimulates.csv", OGTTsimulates)
CSV.write("HFMM_personalised_k6_OGTTresiduals.csv", OGTTresiduals)
